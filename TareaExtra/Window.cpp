...
int Window::Initialise()
{
	...
	// CREAR VENTANA
	mainWindow = glfwCreateWindow(width, height, "Tarea extra: Cocinado de luces", NULL, NULL);
...
void Window::ManejaTeclado(GLFWwindow *window, int key, int code, int action, int mode)
{
	...
	{
		theWindow->toggleLight = !theWindow->toggleLight;
	}
	if (key >= 0 && key < 1024)
	{
...
bool Window::isToggleLight() const
{
	return toggleLight;
}
